...
export const sampleUsers: User[] = [
  ...
  { email: 'philippines2@example.com', password: 'password3', name: 'Pedro Santos', role: 'viewer' },
  { email: 'vietnam1@example.com', password: 'password4', name: 'Lan Nguyen', role: 'manager', gender: 'female' },
  { email: 'vietnam2@example.com', password: 'password5', name: 'Hai Pham', role: 'viewer' },
];